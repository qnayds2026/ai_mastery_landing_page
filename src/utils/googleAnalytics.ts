...
/**
 * Track Initiate Checkout event for GA4
 */
export const trackGaBeginCheckout = (value: number, currency: string = 'INR', itemName: string = 'Qnayds AI Academy Course') => {
...
export const trackGaPurchase = (
  ...
  value: number,
  currency: string = 'INR',
  itemName: string = 'Qnayds AI Academy Course'
) => {
